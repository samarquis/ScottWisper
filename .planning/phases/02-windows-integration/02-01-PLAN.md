...
files_modified: [WhisperKey.csproj, TextInjectionService.cs]
autonomous: true
must_haves:
  truths:
...
4. Update package references in WhisperKey.csproj
