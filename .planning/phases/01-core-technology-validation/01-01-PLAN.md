...
wave: 1
depends_on: []
files_modified: [WhisperKey.csproj, App.xaml.cs, MainWindow.xaml, MainWindow.xaml.cs, HotkeyService.cs]
autonomous: true
must_haves:
  truths:
...
<task type="auto">
  ...
  <files>WhisperKey.csproj, App.xaml, App.xaml.cs, MainWindow.xaml, MainWindow.xaml.cs</files>
  <action>
Create a new WinUI 3 desktop application targeting .NET 8:
1. Create WhisperKey.csproj with WinUI 3 SDK reference and .NET 8 target framework
