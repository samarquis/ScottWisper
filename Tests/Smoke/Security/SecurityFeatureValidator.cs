...
namespace WhisperKey.Tests.Smoke.Security
{
    /// <summary>
    ...
    public class SecurityFeatureValidator : SmokeTestFramework
    {
        ...
        public override async Task<SmokeTestSuiteResult> RunAllTestsAsync()
        {
            ...
            try
            {
                _logger.Information("Starting security feature validation");
                ...
                _logger.Information("Security feature validation completed: {PassedTests}/{TotalTests} passed", 
            ...
            {
                _logger.Error(ex, "Security feature validation failed with exception");
