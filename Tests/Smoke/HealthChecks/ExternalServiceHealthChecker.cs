...
namespace WhisperKey.Tests.Smoke.HealthChecks
{
    ...
    public class ExternalServiceHealthChecker : SmokeTestFramework
    {
        ...
        public override async Task<SmokeTestSuiteResult> RunAllTestsAsync()
        {
            ...
            try
            {
                _logger.Information("Starting external service health checks");
                ...
                _logger.Information("External service health checks completed: {PassedTests}/{TotalTests} passed", 
            ...
            {
                _logger.Error(ex, "External service health checks failed with exception");
    ...
    public class BasicConnectivityChecker : SmokeTestFramework
    {
        ...
        public override async Task<SmokeTestSuiteResult> RunAllTestsAsync()
        {
            ...
            try
            {
                _logger.Information("Starting basic connectivity checks");
                ...
                _logger.Information("Basic connectivity checks completed: {PassedTests}/{TotalTests} passed", 
                    suiteResult.PassedTests, suiteResult.TotalTests);
            ...
            {
                _logger.Error(ex, "Basic connectivity checks failed with exception");
