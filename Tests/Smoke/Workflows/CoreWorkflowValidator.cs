...
namespace WhisperKey.Tests.Smoke.Workflows
{
    /// <summary>
    ...
    public class CoreWorkflowValidator : SmokeTestFramework
    {
        ...
        public override async Task<SmokeTestSuiteResult> RunAllTestsAsync()
        {
            ...
            try
            {
                _logger.Information("Starting core workflow validation");
                ...
                _logger.Information("Core workflow validation completed: {PassedTests}/{TotalTests} passed", 
            ...
            {
                _logger.Error(ex, "Core workflow validation failed with exception");
        ...
        private async Task<SmokeTestResult> TestAudioTranscriptionWorkflowAsync()
        {
            ...
            try
            {
                ...
                var audioDevices = await _audioDeviceService.GetAvailableDevicesAsync();
        ...
        private async Task<SmokeTestResult> TestHotkeyWorkflowAsync()
        {
            ...
            try
            {
                ...
                var hotkeyConfigured = !string.IsNullOrEmpty(settings.GlobalHotkey);
                configStart.Stop();
                ...
                result.Metrics["HotkeyValue"] = settings.GlobalHotkey ?? "NotSet";
        ...
        private async Task<SmokeTestResult> TestSettingsWorkflowAsync()
        {
            ...
            try
            {
                ...
                var persistedCorrectly = reloadedSettings.TestMode == settings.TestMode;
