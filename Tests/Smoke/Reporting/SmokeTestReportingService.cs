...
namespace WhisperKey.Tests.Smoke.Reporting
{
    /// <summary>
    ...
    public class SmokeTestReportingService
    {
        ...
        public async Task<SmokeTestProductionReport> GenerateProductionReportAsync(SmokeTestSuiteResult testResults)
        {
            ...
            _logger.Information("Production smoke test report generated: {PassedTests}/{TotalTests} passed, Success Rate: {SuccessRate:F1}%",
        ...
        {
            await System.IO.Directory.CreateDirectoryAsync(outputDirectory);
            ...
            _logger.Information("Production smoke test report exported to {OutputDirectory}", outputDirectory);
        }
