...
namespace WhisperKey.Infrastructure.SmokeTesting.HealthChecks
{
    ...
    public class SystemHealthChecker : SmokeTestFramework
    {
        ...
        public override async Task<SmokeTestSuiteResult> RunAllTestsAsync()
        {
            ...
            try
            {
                _logger.LogInformation("Starting system health checks");
                ...
                _logger.LogInformation("System health checks completed: {PassedTests}/{TotalTests} passed", 
            ...
            {
                _logger.LogError(ex, "System health checks failed with exception");
