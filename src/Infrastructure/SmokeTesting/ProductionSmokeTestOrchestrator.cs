...
using WhisperKey.Infrastructure.SmokeTesting.Workflows;
using WhisperKey.Infrastructure.SmokeTesting.Performance;
using WhisperKey.Infrastructure.SmokeTesting.Security;
using WhisperKey.Infrastructure.SmokeTesting.Deployment;
...
namespace WhisperKey.Infrastructure.SmokeTesting
{
    ...
    public class ProductionSmokeTestOrchestrator
    {
        ...
        public async Task<SmokeTestProductionReport> RunProductionSmokeTestsAsync()
        {
            ...
            try
            {
                _logger.LogInformation("Starting comprehensive production smoke test suite");
                ...
                _logger.LogInformation("Production smoke test suite completed in {Duration}s: {PassedTests}/{TotalTests} passed, Success Rate: {SuccessRate:F1}%",
            ...
            {
                _logger.LogError(ex, "Production smoke test suite failed");
                throw;
            }
            finally
            {
        ...
        {
            _logger.LogInformation("Running critical smoke tests");
        ...
        {
            _logger.LogInformation("Running health check smoke tests");
        ...
        {
            _logger.LogInformation("Running workflow smoke tests");
        ...
        {
            _logger.LogInformation("Running performance smoke tests");
        ...
        {
            _logger.LogInformation("Running security smoke tests");
        ...
        {
            _logger.LogInformation("Running external service smoke tests");
        ...
        {
            _logger.LogInformation("Running deployment smoke tests");
